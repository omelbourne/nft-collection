...
contract Antiparallel is ERC721Enumerable, Ownable {
    /**
    ...
    */
    ...
    //  _price is the price of one Antiparallel NFT
    uint256 public _price = 0.01 ether;

    // _paused is used to pause the contract in case of an emergency
    bool public _paused;

    // max number of Antiparallel tokens
    ...
    * Antiparallel constructor takes in the baseURI to set _baseTokenURI for the collection.
    * It also initializes an instance of whitelist interface.
    */
    constructor (string memory baseURI, address whitelistContract) ERC721("Antiparallel", "APAR") {
