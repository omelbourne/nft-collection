...
export default function Home() {
  ...
  const presaleMint = async () => {
    try {
      ...
      // call the presaleMint from the contract, only whitelisted addresses are able to mint
      ...
      await tx.wait();
      setLoading(false);
      window.alert("You successfully minted an Antiparallel!");
    } catch (err) {
      console.error(err);
    }
  };
      ...
      return (
        <div>
          <div className={styles.description}>
            Presale has started! If your address is whitelisted, mint an
            Antiparallel 🥳
          </div>
    ...
    <div>
      ...
      <div className={styles.main}>
        <div className={styles.topContainer}>
          <h1 className={styles.title}>Antiparallel NFT Collection</h1>
          <div className={styles.description}>
            An NFT collection for those that like the cards!
          </div>
          <div className={styles.description}>
            {tokenIdsMinted}/200 have been minted
          </div>
          {renderButton()}
        </div>
        <div>
          <img className={styles.image} src="./antiparallel/5.png" />
        </div>
      </div>
